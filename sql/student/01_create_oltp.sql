...
ALTER TABLE orders ALTER COLUMN updated_at SET DEFAULT CURRENT_DATE;

ALTER TABLE order_items ALTER COLUMN updated_at SET DEFAULT CURRENT_DATE;

ALTER TABLE order_items ALTER COLUMN created_at SET DEFAULT CURRENT_DATE;

ALTER TABLE payments ALTER COLUMN updated_at SET DEFAULT CURRENT_DATE;

ALTER TABLE products ALTER COLUMN updated_at SET DEFAULT CURRENT_DATE;
